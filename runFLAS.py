...
#####################################
#	bronkerbosch1_command = 'bronkerbosch.py ' + temp_dir + '/step1/' + 'allreads.fasta.m4 ' + temp_dir + '/step1/' + 'clique1.txt ' + temp_dir + '/step1/' + 'edge1.txt 3 '
#by bao: coverage is included to sample alignments
...
########################################
#	bronkerbosch2_command = 'bronkerbosch.py ' + temp_dir + '/step2/' + 'allreads0_corrected_filted1.fasta.m4 ' + temp_dir + '/step2/' + 'clique2.txt ' +  temp_dir + '/step2/' + 'edge2.txt 3'
#by bao: coverage is included to sample alignments
        bronkerbosch2_command = 'bronkerbosch.py ' + temp_dir + '/step2/' + 'allreads0_corrected_filted1.fasta.m4 ' + temp_dir + '/step2/' + 'clique2.txt ' +  temp_dir + '/step2/' + 'edge2.txt ' + str(args.c)
